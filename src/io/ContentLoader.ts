...
import archetypeBulwarkJson from '@content/archetypes/spear/Bulwark.json'
...
import archetypeReaverJson from '@content/archetypes/axe/Reaver.json'
...
export const CoreContent = {
  ...
  archetypes: {
    ...
    characters: {
      ...
      bulwark: archetypeBulwarkJson as IArchetypeCharacterData,
      ...
      reaver: archetypeReaverJson as IArchetypeCharacterData,
